            ...
            questions: [
                {
                    ...
                    answers: [
                        ...
                        { content: "Język programowania", id: "second", correctAnswer: true },
                        { content: "Nazwa firmy produkującej oprogramowanie", id: "third", correctAnswer: false },
                        { content: "Typ maszyny do pisania", id: "fourth", correctAnswer: false }
                    ]
                },
                {
                    timeSpent: 0,
                    ...
                    answers: [
                        ...
                        { content: "System kontroli wersji", id: "third", correctAnswer: true },
                ...
                },
                {
                    ...
                    answers: [
                        { content: "Aplikacja internetowa", id: "first", correctAnswer: false },
                        { content: "Automatyczne przetwarzanie informacji", id: "second", correctAnswer: false },
                        { content: "Interfejs programowania aplikacji", id: "third", correctAnswer: true },
                        { content: "Asynchroniczne programowanie internetowe", id: "fourth", correctAnswer: false }
                    ]
                },
                {
                    timeSpent: 0,
                    ...
                    answers: [
                        { content: "Proces programowania", id: "first", correctAnswer: false },
                        { content: "Usuwanie błędów w kodzie", id: "second", correctAnswer: true },
                        { content: "Tworzenie interfejsu użytkownika", id: "third", correctAnswer: false },
                ...
                },
                {
                    ...
                    answers: [
                        { content: "Zmienna przechowująca dane", id: "first", correctAnswer: false },
                        { content: "Instrukcja warunkowa", id: "second", correctAnswer: false },
                        { content: "Struktura danych", id: "third", correctAnswer: false },
                        { content: "Fragment kodu wykonywany wielokrotnie", id: "fourth", correctAnswer: true }
                    ]
                }]
        },{
            title: "Religia",
            questions: [
                {
                    ...
                    answers: [
                        ...
                        { content: "Budda Siddhartha Gautama", id: "third", correctAnswer: true },
                ...
                },
                {
                    ...
                    answers: [
                        ...
                        { content: "Święta księga islamu", id: "second", correctAnswer: true },
            ...
            questions: [
                ...
                },
                {
                    ...
                    answers: [
                        ...
                        { content: "Tradycyjna herbata", id: "third", correctAnswer: false },
                ...
                },
                {
                    ...
                    answers: [
                        { content: "Typ japońskiego jedzenia", id: "first", correctAnswer: false },
                        { content: "Sztuka origami", id: "second", correctAnswer: false },
                        { content: "Ubieranie się w stroje postaci z anime", id: "third", correctAnswer: true },
                        { content: "Japońska sztuka walki", id: "fourth", correctAnswer: false }
                    ]
                }                
            ]  
        }
